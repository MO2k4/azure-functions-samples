...
param orders_http_containerimage string

param orders_http_identity_outputs_id string
...
param orders_http_identity_outputs_clientid string
...
resource orders_http 'Microsoft.App/containerApps@2025-10-02-preview' = {
  name: 'orders-http'
  location: location
  properties: {
    configuration: {
    ...
    template: {
      containers: [
        {
          image: orders_http_containerimage
          name: 'orders-http'
          env: [
            {
            ...
            }
            {
              ...
              value: orders_http_identity_outputs_clientid
            }
            {
  ...
  identity: {
    ...
    userAssignedIdentities: {
      '${orders_http_identity_outputs_id}': { }
